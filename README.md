...
![](https://img.shields.io/badge/B.E.-Information%20Technology-6D28D9?style=for-the-badge)
![](https://img.shields.io/badge/CGPA-8.64-2563EB?style=for-the-badge)
...
![](https://img.shields.io/badge/University-NBN%20Sinhgad%20Technical%20Institutes%20Campus%20Pune-2563EB?style=flat-square)
...
<a href="mailto:parthkedar456@gmail.com">
...
|:-------|:-----------:|:--------|
| Machine Learning | ★★★★☆ | Model training, preprocessing, evaluation |
| Deep Learning | ★★★★☆ | TensorFlow Lite, EfficientNet, CNNs |
| Computer Vision | ★★★★☆ | Facial Emotion Recognition, OpenCV |
| NLP | ★★★☆☆ | Sentiment Analysis, Text Processing |
| AI Deployment | ★★★★☆ | ONNX Runtime integration |
| Cloud AI | ★★★★☆ | Microsoft Azure AI Fundamentals (AI-900) |
| Data Processing | ★★★★☆ | NumPy, Pandas, SQL |
| Recommendation Systems | ★★★☆☆ | AI-driven personalized recommendations |
...
| Category | Details |
|----------|---------|
| Stack | Flutter, Node.js, Express.js, PostgreSQL, MongoDB, Python, ONNX Runtime |
| Scale | Multi-module Full Stack Application |
| Performance | Optimized ONNX inference with EfficientNetV2B0 |
| Security | JWT Authentication, Secure REST APIs |
...
| Category | Details |
|----------|---------|
| Stack | GIS, Google Earth Engine, Remote Sensing |
| Scale | Research Publication |
| Impact | Urban resilience & planning |
| Journal | IJCA |
| Year | 2025 |
...
- Participated in debugging, testing, and code optimization.
- Collaborated with mentors through code reviews and technical discussions.
...
| Recognition | Details |
|--------------|---------|
| 🎓 B.E. Information Technology | Graduated with **CGPA 8.64** |
| 📄 Research Publication | Co-authored research paper published in **International Journal of Computer Applications (IJCA)** |
| ☁ Microsoft Certified | Successfully earned **Azure AI Fundamentals (AI-900)** |
| ☁ Oracle Certified | Oracle Cloud Infrastructure Foundations Associate |
| 💻 Java Development | Completed Java Developer Internship at **SORT Solutions** |
| 🏆 Smart India Hackathon | Participated in SIH and developed innovative software solutions |
| 🌱 NSS Volunteer | Contributed to social service, education, blood donation, and environmental initiatives |
| 🚀 Multiple Software Projects | Developed AI, Java, Full Stack, and Backend Engineering projects |
...
|---------|-------------|----------|-------|
| **B.E. Information Technology** | NBN Sinhgad Technical Institutes Campus, Pune | 2022 – 2026 | **CGPA: 8.64 / 10** |
...
<img src="https://capsule-render.vercel.app/api?type=waving&section=footer&height=150&color=0:5B21B6,50:7C3AED,100:2563EB"/>
